...
`):e.addLineFlowCode(`${t}Barrier()`,this)}}Ut(P2);class Ui extends ze{static get type(){return"AtomicFunctionNode"}constructor(e,t,n){super("uint"),this.method=e,this.pointerNode=t,this.valueNode=n,this.parents=!0}getInputType(e){return this.pointerNode.getNodeType(e)}getNodeType(e){return this.getInputType(e)}generate(e){const t=e.getNodeProperties(this),n=t.parents,s=this.method,r=this.getNodeType(e),a=this.getInputType(e),o=this.pointerNode,l=this.valueNode,c=[];c.push(`&${o.build(e,a)}`),l!==null&&c.push(l.build(e,a));const u=`${e.getMethod(s,r)}( ${c.join(", ")} )`;if(n?n.length===1&&n[0].isStackNode===!0:!1)e.addLineFlowCode(u,this);else return t.constNode===void 0&&(t.constNode=Lc(u,r).toConst()),t.constNode.build(e)}}Ui.ATOMIC_LOAD="atomicLoad";Ui.ATOMIC_STORE="atomicStore";Ui.ATOMIC_ADD="atomicAdd";Ui.ATOMIC_SUB="atomicSub";Ui.ATOMIC_MAX="atomicMax";Ui.ATOMIC_MIN="atomicMin";Ui.ATOMIC_AND="atomicAnd";Ui.ATOMIC_OR="atomicOr";Ui.ATOMIC_XOR="atomicXor";Ut(Ui);class st extends hn{static get type(){return"SubgroupFunctionNode"}constructor(e,t=null,n=null){super(),this.method=e,this.aNode=t,this.bNode=n}getInputType(e){const t=this.aNode?this.aNode.getNodeType(e):null,n=this.bNode?this.bNode.getNodeType(e):null,s=e.isMatrix(t)?0:e.getTypeLength(t),r=e.isMatrix(n)?0:e.getTypeLength(n);return s>r?t:n}getNodeType(e){const t=this.method;return t===st.SUBGROUP_ELECT?"bool":t===st.SUBGROUP_BALLOT?"uvec4":this.getInputType(e)}generate(e,t){const n=this.method,s=this.getNodeType(e),r=this.getInputType(e),a=this.aNode,o=this.bNode,l=[];if(n===st.SUBGROUP_BROADCAST||n===st.SUBGROUP_SHUFFLE||n===st.QUAD_BROADCAST){const u=o.getNodeType(e);l.push(a.build(e,s),o.build(e,u==="float"?"int":s))}else n===st.SUBGROUP_SHUFFLE_XOR||n===st.SUBGROUP_SHUFFLE_DOWN||n===st.SUBGROUP_SHUFFLE_UP?l.push(a.build(e,s),o.build(e,"uint")):(a!==null&&l.push(a.build(e,r)),o!==null&&l.push(o.build(e,r)));const c=l.length===0?"()":`( ${l.join(", ")} )`;return e.format(`${e.getMethod(n,s)}${c}`,s,t)}serialize(e){super.serialize(e),e.method=this.method}deserialize(e){super.deserialize(e),this.method=e.method}}st.SUBGROUP_ELECT="subgroupElect";st.SUBGROUP_BALLOT="subgroupBallot";st.SUBGROUP_ADD="subgroupAdd";st.SUBGROUP_INCLUSIVE_ADD="subgroupInclusiveAdd";st.SUBGROUP_EXCLUSIVE_AND="subgroupExclusiveAdd";st.SUBGROUP_MUL="subgroupMul";st.SUBGROUP_INCLUSIVE_MUL="subgroupInclusiveMul";st.SUBGROUP_EXCLUSIVE_MUL="subgroupExclusiveMul";st.SUBGROUP_AND="subgroupAnd";st.SUBGROUP_OR="subgroupOr";st.SUBGROUP_XOR="subgroupXor";st.SUBGROUP_MIN="subgroupMin";st.SUBGROUP_MAX="subgroupMax";st.SUBGROUP_ALL="subgroupAll";st.SUBGROUP_ANY="subgroupAny";st.SUBGROUP_BROADCAST_FIRST="subgroupBroadcastFirst";st.QUAD_SWAP_X="quadSwapX";st.QUAD_SWAP_Y="quadSwapY";st.QUAD_SWAP_DIAGONAL="quadSwapDiagonal";st.SUBGROUP_BROADCAST="subgroupBroadcast";st.SUBGROUP_SHUFFLE="subgroupShuffle";st.SUBGROUP_SHUFFLE_XOR="subgroupShuffleXor";st.SUBGROUP_SHUFFLE_UP="subgroupShuffleUp";st.SUBGROUP_SHUFFLE_DOWN="subgroupShuffleDown";st.QUAD_BROADCAST="quadBroadcast";rt(([i=il()],{renderer:e,material:t})=>{const n=B0(i.mul(2).sub(1));let s;if(t.alphaToCoverage&&e.currentSamples>0){const r=An(n.fwidth()).toVar();s=cf(r.oneMinus(),r.add(1),n).oneMinus()}else s=lf(n.greaterThan(1),0,1);return s});const L2={name:"Light",ui:{background:"white",textColor:"#0d0d0d",border:"rgba(0, 0, 0, 0.6)",focusBorder:"rgb(0, 135, 255)",thickBorder:"rgba(0, 0, 0, 0.8)",lightBorder:"rgba(0, 0, 0, 0.2)",githubImage:"github-mark.svg"},canvas:{foreground:"#000000",isometryColors:[["#ff0000","#cc0000"],["#0000ff","#0000cc"]],axisColors:["#ff9999","#66ff66","#9999ff"]}},eo=[L2,Db];let xx=ft(jt(eo[0]));function Ss(){return J(xx)}function D2(i){const e=eo.find(t=>t.name===i)??eo[0];Fe(xx,e,!0),I2(e)}function I2(i){const e=document.documentElement;e.style.setProperty("--bgColor",i.ui.background),e.style.setProperty("--textColor",i.ui.textColor),e.style.setProperty("--borderColor",i.ui.border),e.style.setProperty("--focusBorderColor",i.ui.focusBorder),e.style.setProperty("--thickBorderColor",i.ui.thickBorder),e.style.setProperty("--isometry1Color",i.canvas.isometryColors[0][0]),e.style.setProperty("--isometry2Color",i.canvas.isometryColors[1][0])}function U2(i=()=>{}){let e,t;const n=a=>{t=requestAnimationFrame(n);const o=e;if(e=a,o===void 0)return;const l=a-o;l>=0&&i(l)},s=()=>{t!==void 0&&(cancelAnimationFrame(t),t=void 0,e=void 0)},r=()=>{t===void 0&&n(performance.now())};return Lb(s),Object.freeze({start:r,stop:s})}var F2=Ns('<div class="plane-input svelte-1cep8g"><canvas class="plane-input-canvas svelte-1cep8g"></canvas></div>');function O2(i,e){rr(e,!0);let t=oi(e,"onchange",3,()=>{}),n=ft(0),s=ft(0),r=ft(jt(St(0))),a=ft(jt(St(0))),o=ft(jt({dragging:!1})),l;Ft(()=>{const v=window.devicePixelRatio||1;Fe(n,l.clientWidth*v),Fe(s,l.clientHeight*v)}),Ft(()=>{l.width=J(n),l.height=J(s)});function c(v){Fe(r,v,!0),Fe(a,v,!0)}const u=-3,h=3,f=-3,d=3;function m(v,N,O){const B=(v.re-u)/(h-u)*N,V=O-(v.im-f)/(d-f)*O;return{x:B,y:V}}function g(v,N,O,B){const V=v/O*(h-u)+u,W=(B-N)/B*(d-f)+f;return St(V,W)}let x,p=gs(()=>Wr(J(a),J(r)));const y=U2(v=>M(v,x));Ft(()=>{x=[l,J(n),J(s),Ss(),J(a),J(p)],y.start()});function M(v,[N,O,B,V,W,Y]){const X=1-Math.exp(-v/90);$1(J(r),W)||t()(J(r)),Ks(Y)<1e-4?(Fe(r,W,!0),y.stop()):Fe(r,Sn(J(r),hh(Y,X)),!0),T(N,O,B,V)}function T(v,N,O,B){const V=v.getContext("2d");if(!v||!V)return;V.clearRect(0,0,N,O);const W=m(St(0,0),N,O);V.beginPath(),V.strokeStyle=B.ui.lightBorder,V.lineWidth=1*window.devicePixelRatio,V.moveTo(0,W.y),V.lineTo(N,W.y),V.moveTo(W.x,0),V.lineTo(W.x,O),V.stroke();const Y=m(J(r),N,O);V.beginPath(),V.fillStyle=B.ui.textColor,V.arc(Y.x,Y.y,3*window.devicePixelRatio,0,2*Math.PI),V.fill()}let A=ft(!1);Ma(window,"keydown",v=>{v.key==="Shift"&&Fe(A,!0)}),Ma(window,"keyup",v=>{v.key==="Shift"&&Fe(A,!1)}),Ma(window,["blur","visibilitychange"],()=>{Fe(A,!1)});function E(v){Fe(o,{dragging:!0,mouse:{x:v.clientX,y:v.clientY},startValue:J(r)},!0)}Ft(()=>{if(J(o).dragging===!1)return;let v=J(o),N=gs(()=>{const V=l.getBoundingClientRect(),W=(v.mouse.x-V.left)*window.devicePixelRatio,Y=(v.mouse.y-V.top)*window.devicePixelRatio;return g(W,Y,l.width,l.height)}),O=ft(void 0);Ft(()=>{if(J(A)){let V=Rs(()=>J(O));const W=Math.abs(J(N).re-v.startValue.re),Y=Math.abs(J(N).im-v.startValue.im);V==="x"&&W>.3&&(V=void 0),V==="y"&&Y>.3&&(V=void 0),V||Fe(O,W>Y?"x":"y",!0)}else Fe(O,void 0)});let B=gs(()=>J(A)?J(O)==="x"?St(J(N).re,v.startValue.im):St(v.startValue.re,J(N).im):J(N));Ft(()=>{Fe(a,J(B),!0)}),Ma(window,"mousemove",V=>{v.mouse={x:V.clientX,y:V.clientY}}),Ma(window,"mouseup",()=>{Fe(o,{dragging:!1},!0)})}),Lh(()=>{const v=new ResizeObserver(()=>{const N=window.devicePixelRatio||1;Fe(n,l.clientWidth*N),Fe(s,l.clientHeight*N)});return v.observe(l,{box:"device-pixel-content-box"}),()=>{v.disconnect()}});var w={setValue:c},L=F2(),b=Vt(L);return b.__mousedown=E,Vr(b,v=>l=v,()=>l),Es(i,L),ar(w)}Yc(["mousedown"]);var z2=Ns('<div class="number-input svelte-1pzowlr"><input type="text" class="svelte-1pzowlr"/> <div class="number-input-buttons svelte-1pzowlr"><button type="button" aria-label="Increment" class="number-input-up svelte-1pzowlr"><i class="svelte-1pzowlr"></i></button> <button type="button" aria-label="Decrement" class="number-input-down svelte-1pzowlr"><i class="svelte-1pzowlr"></i></button></div></div>');function B2(i,e){rr(e,!0);let t=oi(e,"min",3,1),n=oi(e,"max",3,100),s=oi(e,"init",19,t),r=oi(e,"valid",3,w=>!0),a=oi(e,"onchange",3,w=>{}),o=ft(jt(s().toString())),l=ft(jt(s().toString())),c=ft(jt(s()));const u=w=>w!==J(c)?(Fe(c,w,!0),Fe(o,w.toString(),!0),!0):!1;function h(w){u(w)&&a()(new CustomEvent("change",{detail:w}))}function f(){for(let w=J(c)+1;w<=n();w++)if(r()(w)){h(w);return}}function d(){for(let w=J(c)-1;w>=t();w--)if(r()(w)){h(w);return}}function m(){if(!g(J(o))){Fe(o,J(l),!0);return}Fe(l,J(o),!0),x(J(o))&&(Fe(c,Number(J(o)),!0),a()(new CustomEvent("change",{detail:J(c)})))}function g(w){if(w==="")return!0;if(/^(0|[1-9]\d*)$/.test(w)){const L=Number(w);if((t()<=0||L>0)&&L<=n())return!0}return!1}function x(w){if(w==="")return!1;const L=Number(w);return t()<=L&&n()>=L&&r()(L)}var p={set:u},y=z2(),M=Vt(y);M.__input=m;var T=xn(M,2),A=Vt(T);A.__click=f;var E=xn(A,2);return E.__click=d,Cm(M,()=>J(o),w=>Fe(o,w)),Es(i,y),ar(p)}Yc(["input","click"]);const nu={type:"change"},_f={type:"start"},vf={type:"end"},Mp=1e-6,dt={NONE:-1,ROTATE:0,ZOOM:1,PAN:2,TOUCH_ROTATE:3,TOUCH_ZOOM_PAN:4},ec=new je,xs=new je,V2=new F,tc=new F,iu=new F,Fr=new oa,Tp=new F,nc=new F,su=new F,ic=new F;class k2 extends ny{constructor(e,t=null){super(e,t),this.screen={left:0,top:0,width:0,height:0},this.rotateSpeed=1,this.zoomSpeed=1.2,this.panSpeed=.3,this.noRotate=!1,this.noZoom=!1,this.noPan=!1,this.staticMoving=!1,this.dynamicDampingFactor=.2,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.keys=["KeyA","KeyS","KeyD"],this.mouseButtons={LEFT:kr.ROTATE,MIDDLE:kr.DOLLY,RIGHT:kr.PAN},this.target=new F,this.state=dt.NONE,this.keyState=dt.NONE,this._lastPosition=new F,this._lastZoom=1,this._touchZoomDistanceStart=0,this._touchZoomDistanceEnd=0,this._lastAngle=0,this._eye=new F,this._movePrev=new je,this._moveCurr=new je,this._lastAxis=new F,this._zoomStart=new je,this._zoomEnd=new je,this._panStart=new je,this._panEnd=new je,this._pointers=[],this._pointerPositions={},this._onPointerMove=H2.bind(this),this._onPointerDown=G2.bind(this),this._onPointerUp=W2.bind(this),this._onPointerCancel=X2.bind(this),this._onContextMenu=J2.bind(this),this._onMouseWheel=K2.bind(this),this._onKeyDown=Y2.bind(this),this._onKeyUp=q2.bind(this),this._onTouchStart=Q2.bind(this),this._onTouchMove=eC.bind(this),this._onTouchEnd=tC.bind(this),this._onMouseDown=$2.bind(this),this._onMouseMove=Z2.bind(this),this._onMouseUp=j2.bind(this),this._target0=this.target.clone(),this._position0=this.object.position.clone(),this._up0=this.object.up.clone(),this._zoom0=this.object.zoom,t!==null&&(this.connect(t),this.handleResize()),this.update()}connect(e){super.connect(e),window.addEventListener("keydown",this._onKeyDown),window.addEventListener("keyup",this._onKeyUp),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerCancel),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.style.touchAction="none"}disconnect(){window.removeEventListener("keydown",this._onKeyDown),window.removeEventListener("keyup",this._onKeyUp),this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerCancel),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}handleResize(){const e=this.domElement.getBoundingClientRect(),t=this.domElement.ownerDocument.documentElement;this.screen.left=e.left+window.pageXOffset-t.clientLeft,this.screen.top=e.top+window.pageYOffset-t.clientTop,this.screen.width=e.width,this.screen.height=e.height}update(){this._eye.subVectors(this.object.position,this.target),this.noRotate||this._rotateCamera(),this.noZoom||this._zoomCamera(),this.noPan||this._panCamera(),this.object.position.addVectors(this.target,this._eye),this.object.isPerspectiveCamera?(this._checkDistances(),this.object.lookAt(this.target),this._lastPosition.distanceToSquared(this.object.position)>Mp&&(this.dispatchEvent(nu),this._lastPosition.copy(this.object.position))):this.object.isOrthographicCamera?(this.object.lookAt(this.target),(this._lastPosition.distanceToSquared(this.object.position)>Mp||this._lastZoom!==this.object.zoom)&&(this.dispatchEvent(nu),this._lastPosition.copy(this.object.position),this._lastZoom=this.object.zoom)):console.warn("THREE.TrackballControls: Unsupported camera type.")}reset(){this.state=dt.NONE,this.keyState=dt.NONE,this.target.copy(this._target0),this.object.position.copy(this._position0),this.object.up.copy(this._up0),this.object.zoom=this._zoom0,this.object.updateProjectionMatrix(),this._eye.subVectors(this.object.position,this.target),this.object.lookAt(this.target),this.dispatchEvent(nu),this._lastPosition.copy(this.object.position),this._lastZoom=this.object.zoom}_panCamera(){if(xs.copy(this._panEnd).sub(this._panStart),xs.lengthSq()){if(this.object.isOrthographicCamera){const e=(this.object.right-this.object.left)/this.object.zoom/this.domElement.clientWidth,t=(this.object.top-this.object.bottom)/this.object.zoom/this.domElement.clientWidth;xs.x*=e,xs.y*=t}xs.multiplyScalar(this._eye.length()*this.panSpeed),tc.copy(this._eye).cross(this.object.up).setLength(xs.x),tc.add(V2.copy(this.object.up).setLength(xs.y)),this.object.position.add(tc),this.target.add(tc),this.staticMoving?this._panStart.copy(this._panEnd):this._panStart.add(xs.subVectors(this._panEnd,this._panStart).multiplyScalar(this.dynamicDampingFactor))}}_rotateCamera(){ic.set(this._moveCurr.x-this._movePrev.x,this._moveCurr.y-this._movePrev.y,0);let e=ic.length();e?(this._eye.copy(this.object.position).sub(this.target),Tp.copy(this._eye).normalize(),nc.copy(this.object.up).normalize(),su.crossVectors(nc,Tp).normalize(),nc.setLength(this._moveCurr.y-this._movePrev.y),su.setLength(this._moveCurr.x-this._movePrev.x),ic.copy(nc.add(su)),iu.crossVectors(ic,this._eye).normalize(),e*=this.rotateSpeed,Fr.setFromAxisAngle(iu,e),this._eye.applyQuaternion(Fr),this.object.up.applyQuaternion(Fr),this._lastAxis.copy(iu),this._lastAngle=e):!this.staticMoving&&this._lastAngle&&(this._lastAngle*=Math.sqrt(1-this.dynamicDampingFactor),this._eye.copy(this.object.position).sub(this.target),Fr.setFromAxisAngle(this._lastAxis,this._lastAngle),this._eye.applyQuaternion(Fr),this.object.up.applyQuaternion(Fr)),this._movePrev.copy(this._moveCurr)}_zoomCamera(){let e;this.state===dt.TOUCH_ZOOM_PAN?(e=this._touchZoomDistanceStart/this._touchZoomDistanceEnd,this._touchZoomDistanceStart=this._touchZoomDistanceEnd,this.object.isPerspectiveCamera?this._eye.multiplyScalar(e):this.object.isOrthographicCamera?(this.object.zoom=rh.clamp(this.object.zoom/e,this.minZoom,this.maxZoom),this._lastZoom!==this.object.zoom&&this.object.updateProjectionMatrix()):console.warn("THREE.TrackballControls: Unsupported camera type")):(e=1+(this._zoomEnd.y-this._zoomStart.y)*this.zoomSpeed,e!==1&&e>0&&(this.object.isPerspectiveCamera?this._eye.multiplyScalar(e):this.object.isOrthographicCamera?(this.object.zoom=rh.clamp(this.object.zoom/e,this.minZoom,this.maxZoom),this._lastZoom!==this.object.zoom&&this.object.updateProjectionMatrix()):console.warn("THREE.TrackballControls: Unsupported camera type")),this.staticMoving?this._zoomStart.copy(this._zoomEnd):this._zoomStart.y+=(this._zoomEnd.y-this._zoomStart.y)*this.dynamicDampingFactor)}_getMouseOnScreen(e,t){return ec.set((e-this.screen.left)/this.screen.width,(t-this.screen.top)/this.screen.height),ec}_getMouseOnCircle(e,t){return ec.set((e-this.screen.width*.5-this.screen.left)/(this.screen.width*.5),(this.screen.height+2*(this.screen.top-t))/this.screen.width),ec}_addPointer(e){this._pointers.push(e)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t].pointerId==e.pointerId){this._pointers.splice(t,1);return}}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new je,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0].pointerId?this._pointers[1]:this._pointers[0];return this._pointerPositions[t.pointerId]}_checkDistances(){(!this.noZoom||!this.noPan)&&(this._eye.lengthSq()>this.maxDistance*this.maxDistance&&(this.object.position.addVectors(this.target,this._eye.setLength(this.maxDistance)),this._zoomStart.copy(this._zoomEnd)),this._eye.lengthSq()<this.minDistance*this.minDistance&&(this.object.position.addVectors(this.target,this._eye.setLength(this.minDistance)),this._zoomStart.copy(this._zoomEnd)))}}function G2(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i))}function H2(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function W2(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchEnd(i):this._onMouseUp(),this._removePointer(i),this._pointers.length===0&&(this.domElement.releasePointerCapture(i.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp)))}function X2(i){this._removePointer(i)}function q2(){this.enabled!==!1&&(this.keyState=dt.NONE,window.addEventListener("keydown",this._onKeyDown))}function Y2(i){this.enabled!==!1&&(window.removeEventListener("keydown",this._onKeyDown),this.keyState===dt.NONE&&(i.code===this.keys[dt.ROTATE]&&!this.noRotate?this.keyState=dt.ROTATE:i.code===this.keys[dt.ZOOM]&&!this.noZoom?this.keyState=dt.ZOOM:i.code===this.keys[dt.PAN]&&!this.noPan&&(this.keyState=dt.PAN)))}function $2(i){let e;switch(i.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case kr.DOLLY:this.state=dt.ZOOM;break;case kr.ROTATE:this.state=dt.ROTATE;break;case kr.PAN:this.state=dt.PAN;break;default:this.state=dt.NONE}const t=this.keyState!==dt.NONE?this.keyState:this.state;t===dt.ROTATE&&!this.noRotate?(this._moveCurr.copy(this._getMouseOnCircle(i.pageX,i.pageY)),this._movePrev.copy(this._moveCurr)):t===dt.ZOOM&&!this.noZoom?(this._zoomStart.copy(this._getMouseOnScreen(i.pageX,i.pageY)),this._zoomEnd.copy(this._zoomStart)):t===dt.PAN&&!this.noPan&&(this._panStart.copy(this._getMouseOnScreen(i.pageX,i.pageY)),this._panEnd.copy(this._panStart)),this.dispatchEvent(_f)}function Z2(i){const e=this.keyState!==dt.NONE?this.keyState:this.state;e===dt.ROTATE&&!this.noRotate?(this._movePrev.copy(this._moveCurr),this._moveCurr.copy(this._getMouseOnCircle(i.pageX,i.pageY))):e===dt.ZOOM&&!this.noZoom?this._zoomEnd.copy(this._getMouseOnScreen(i.pageX,i.pageY)):e===dt.PAN&&!this.noPan&&this._panEnd.copy(this._getMouseOnScreen(i.pageX,i.pageY))}function j2(){this.state=dt.NONE,this.dispatchEvent(vf)}function K2(i){if(this.enabled!==!1&&this.noZoom!==!0){switch(i.preventDefault(),i.deltaMode){case 2:this._zoomStart.y-=i.deltaY*.025;break;case 1:this._zoomStart.y-=i.deltaY*.01;break;default:this._zoomStart.y-=i.deltaY*25e-5;break}this.dispatchEvent(_f),this.dispatchEvent(vf)}}function J2(i){this.enabled!==!1&&i.preventDefault()}function Q2(i){switch(this._trackPointer(i),this._pointers.length){case 1:this.state=dt.TOUCH_ROTATE,this._moveCurr.copy(this._getMouseOnCircle(this._pointers[0].pageX,this._pointers[0].pageY)),this._movePrev.copy(this._moveCurr);break;default:this.state=dt.TOUCH_ZOOM_PAN;const e=this._pointers[0].pageX-this._pointers[1].pageX,t=this._pointers[0].pageY-this._pointers[1].pageY;this._touchZoomDistanceEnd=this._touchZoomDistanceStart=Math.sqrt(e*e+t*t);const n=(this._pointers[0].pageX+this._pointers[1].pageX)/2,s=(this._pointers[0].pageY+this._pointers[1].pageY)/2;this._panStart.copy(this._getMouseOnScreen(n,s)),this._panEnd.copy(this._panStart);break}this.dispatchEvent(_f)}function eC(i){switch(this._trackPointer(i),this._pointers.length){case 1:this._movePrev.copy(this._moveCurr),this._moveCurr.copy(this._getMouseOnCircle(i.pageX,i.pageY));break;default:const e=this._getSecondPointerPosition(i),t=i.pageX-e.x,n=i.pageY-e.y;this._touchZoomDistanceEnd=Math.sqrt(t*t+n*n);const s=(i.pageX+e.x)/2,r=(i.pageY+e.y)/2;this._panEnd.copy(this._getMouseOnScreen(s,r));break}}function tC(i){switch(this._pointers.length){case 0:this.state=dt.NONE;break;case 1:this.state=dt.TOUCH_ROTATE,this._moveCurr.copy(this._getMouseOnCircle(i.pageX,i.pageY)),this._movePrev.copy(this._moveCurr);break;case 2:this.state=dt.TOUCH_ZOOM_PAN;for(let e=0;e<this._pointers.length;e++)if(this._pointers[e].pointerId!==i.pointerId){const t=this._pointerPositions[this._pointers[e].pointerId];this._moveCurr.copy(this._getMouseOnCircle(t.x,t.y)),this._movePrev.copy(this._moveCurr);break}break}this.dispatchEvent(vf)}const nC={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
      ...
      `+o},n.uniforms.fadeColor={value:void 0},n.uniforms.fadeNear={type:"f",value:void 0},n.uniforms.fadeFar={type:"f",value:void 0},n.uniforms.fadeStrength={type:"f",value:void 0},Ft(()=>{if(!this.uniforms){this.ready=!1;return}n.uniforms.fadeColor.value=this.uniforms.fadeColor,n.uniforms.fadeNear.value=this.uniforms.fadeNear,n.uniforms.fadeFar.value=this.uniforms.fadeFar,n.uniforms.fadeStrength.value=this.uniforms.fadeStrength}),this.geometry=new Th,Ft(()=>{!this.uniforms||this.ready||(this.mesh=new hC(this.geometry,n),this.ready=!0)})}setGeometry(e,t,n,s=K1()){this.generators=e.map(o=>[o,f0(o)]).flat(),this.depth=n,this.colors=t;const r={vertexColors:[],vertices:[],lineColors:[],lines:[]},a=cu(s);this._tree(0,1,void 0,a,s,Uc(a),r),this.geometry&&this.geometry.dispose(),this.geometry=new Th,this.geometry.setPositions(r.lines),this.geometry.setColors(r.lineColors),this.mesh&&(this.mesh.geometry=this.geometry)}_tree(e,t,n,s,r,a,o){if(!(e>=this.depth||t<this.minSize)&&!(e>0&&nb(r,1e-4)))for(let l=0;l<this.generators.length;l++){if(this.inverse(l)===n)continue;const c=fh(r,this.generators[l]),u=cu(c),h=Uc(cu(c)),f=lb(a,h),d=Math.floor(Math.min(Math.max(f*100,2),10)),m=new et(this.colors[l]).toArray();o.vertexColors.push(m[0],m[1],m[2]),o.vertices.push(h.x,h.y,h.z);for(let g=0;g<d*2-2;g++)o.lineColors.push(m[0],m[1],m[2]);dC(s,u,d,o.lines),this._tree(e+1,f,l,u,c,h,o)}}inverse(e){return e%2?e-1:e+1}}function mC(i,e){let t=ft(i);return{get(){return J(t)},set(n){e(J(t),n)||Fe(t,n)}}}var xC=Ns('<canvas class="tree-canvas"></canvas>');function gC(i,e){rr(e,!0);let t=0;Ft(()=>{e.animateIso||J(l)(e.gens,e.colors,e.depth)});let n=window.devicePixelRatio,s,r,a,o=mC(void 0,(h,f)=>h===f||h!==void 0&&f!==void 0&&h.equals(f)),l=ft(()=>{}),c=ft(void 0);Ft(()=>{const h=o.get();!J(c)||!h||(J(c).uniforms={fadeColor:new et(Ss().ui.background).toArray(),fadeNear:h.length()-1,fadeFar:h.length()+1,fadeStrength:.7})}),Lh(()=>{let h=!0;const f=()=>h=!0,d={outline:{vertex_shader:`
